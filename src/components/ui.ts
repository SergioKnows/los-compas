...
const buttonBase='inline-flex min-h-[50px] items-center justify-center gap-3 rounded-md px-[22px] py-[13px] text-sm font-bold transition-[background,transform] duration-200 motion-safe:hover:-translate-y-0.5';
const variants={
...
export const dialogClose=`${iconButton} absolute right-4 top-4 size-9`;
