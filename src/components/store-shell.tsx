...
export function CartLines() {
    const { lines, quantity } = useCart(); return <div>{lines.map(line => {
        const p = productById(line.productId)!, photo = productImages[p.id]?.[0]; return <article className="relative flex gap-[15px] border-b border-line py-6 last:border-b-0" key={line.key}>
