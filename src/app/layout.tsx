...
export const metadata: Metadata = {
  // metadataBase, openGraph y twitter necesitan una URL absoluta real para que las vistas
  // previas de WhatsApp/redes carguen la imagen; no hay dominio publicado todavía.
  // Reactivar (y volver a definir NEXT_PUBLIC_SITE_URL) cuando exista un dominio real.
